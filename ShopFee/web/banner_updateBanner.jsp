                        ...
                        <div class="col-lg-9">
                            <div class="container">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div>  
                                            <b style="font-size: 30px">Update Banner</b><br>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="container" style="margin-top: 20px">
                                <div class="row">
                                    ...
                                    <!-- update banner form -->
                                    <form id="myForm" action="update-banner" method="post" enctype="multipart/form-data">
                                        <!-- banner id -->
                                        <div class="mb-4">
                                            <label for="banner-Id">Banner ID: </label>
                                            <input style="border-radius: 0%; width: 350px" type="text" id="banner-Id" name="banner_Id" value="${banner.getBanner_Id()}" class="form-control" readonly>
                                        </div>

                                        <!-- banner name -->
                                        <div class="mb-4">
                                            <label for="banner-name">Banner Name:</label>
                                            <input style="border-radius: 0%; width: 350px" type="text" id="banner-name" name="banner_Name" value="${banner.getBanner_Name()}" class="form-control" required>
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input style="border-radius: 0%; width: 350px" type="text" id="banner-link" name="banner_Link" value="${banner.getBanner_Link()}" class="form-control" required>
                                        ...
                                        <input type="file" name="Banner_Image" id="imageInput" onchange="previewAvatar()" hidden>
                                        <label for="imageInput" style="margin-top: 10px" class="site-btn">
                                            Choose Image
                                        </label>

                                        <!-- button -->
                                        <button class="site-btn" type="submit" value="avatar">Save Change</button>
                                    </form>
                                </div>
                            </div>
                        </div>
